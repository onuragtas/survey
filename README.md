...
[![GoDoc](http://img.shields.io/badge/godoc-reference-5272B4.svg)](https://pkg.go.dev/github.com/onuragtas/survey/v2)
...
import (
    "fmt"
    "github.com/onuragtas/survey/v2"
)
...
and likely to break your application in these situations. See [#337](https://github.com/onuragtas/survey/pull/337#issue-581351617)
...
`github.com/onuragtas/survey/v2/terminal.InterruptErr` from `Ask` or `AskOne`.
